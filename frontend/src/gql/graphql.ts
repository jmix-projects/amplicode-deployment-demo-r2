...
export type PetTypeQueryVariables = Exact<{
  id?: InputMaybe<Scalars["Long"]>;
}>;

export type PetTypeQuery = {
  __typename?: "Query";
  petType?:
    | {
        __typename?: "PetTypeDTO";
...
export type Update_PetTypeMutationVariables = Exact<{
  input?: InputMaybe<PetTypeInputDtoInput>;
}>;

export type Update_PetTypeMutation = {
  __typename?: "Mutation";
  update_PetType?:
    | {
        __typename?: "PetTypeDTO";
...
export type New_PetTypeDtoFragment = {
  __typename?: "PetTypeDTO";
  id?: any | null | undefined;
};

export type PetTypeListQueryVariables = Exact<{ [key: string]: never }>;

export type PetTypeListQuery = {
  __typename?: "Query";
  petTypeList?:
    | Array<
        | {
...
export type Delete_PetTypeMutationVariables = Exact<{
  id: Scalars["Long"];
}>;

export type Delete_PetTypeMutation = {
  __typename?: "Mutation";
  delete_PetType: boolean;
};
...
export const New_PetTypeDtoFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "New_PetTypeDTO" },
      typeCondition: {
        kind: "NamedType",
        name: { kind: "Name", value: "PetTypeDTO" },
      },
      selectionSet: {
        kind: "SelectionSet",
        selections: [{ kind: "Field", name: { kind: "Name", value: "id" } }],
...
} as unknown as DocumentNode<New_PetTypeDtoFragment, unknown>;
...
} as unknown as DocumentNode<PetTypeQuery, PetTypeQueryVariables>;
export const Update_PetTypeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "update_PetType" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            kind: "NamedType",
            name: { kind: "Name", value: "PetTypeInputDTOInput" },
          },
        },
      ],
      selectionSet: {
  ...
  Update_PetTypeMutation,
  Update_PetTypeMutationVariables
>;
export const PetTypeListDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
...
} as unknown as DocumentNode<PetTypeListQuery, PetTypeListQueryVariables>;
export const Delete_PetTypeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "delete_PetType" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "id" } },
  ...
  Delete_PetTypeMutation,
  Delete_PetTypeMutationVariables
>;
